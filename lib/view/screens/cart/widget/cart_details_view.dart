...
class CartDetailsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
                ...
                child: couponProvider.discount! <= 0
                    ? !couponProvider.isLoading
                        ? Text(
                            ...
                            style:
                                joseFinSansMedium.copyWith(color: Colors.white),
                          )
      ...
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Text(getTranslated('addon_price', context)!,
            style: joseFinSansRegular.copyWith(
                fontSize: Dimensions.fontSizeLarge)),
        CustomDirectionality(
            child: Text(
          PriceConverter.convertPrice(context, _addOnPrice),
          style:
              joseFinSansRegular.copyWith(fontSize: Dimensions.fontSizeLarge),
        )),
      ]),
