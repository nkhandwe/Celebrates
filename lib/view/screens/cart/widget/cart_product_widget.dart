          ...
          Dismissible(
            ...
            child: Container(
              padding: const EdgeInsets.symmetric(
                  vertical: 18, horizontal: Dimensions.paddingSizeSmall),
              decoration: BoxDecoration(
                        ...
                        child: Row(children: [
                          ClipRRect(
                            ...
                            child: FadeInImage.assetNetwork(
                              placeholder: Images.placeholder(context),
                              image:
                                  'https://celebrates.in/admin/storage/app/public/addon/${cart.addOn![index].image!}',
                              height: 70,
                              width: 85,
                              imageErrorBuilder: (c, o, s) => Image.asset(
                                  Images.placeholder(context),
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Expanded(
                                      flex: 2,
                                      child: Text(cart.addOn![index].name!,
                                          style: joseFinSansRegular.copyWith(
                                            fontSize: Dimensions.fontSizeSmall,
                                          ),
                                          maxLines: 2,
                                  ...
                                  CustomDirectionality(
                                    ...
                                    PriceConverter.convertPrice(
                                        context,
                                        double.parse(cart.addOn![index].price!
                                                .toString()) *
                                            double.parse(cart.addOnQty![index]
                                                .toString())),
                                    style: joseFinSansSemiBold.copyWith(
                                        fontSize: Dimensions.fontSizeSmall),
                                  )),
                              ...
                              Row(children: [
                                ...
                                Text(
                                    "Quantity :  ${cart.addOnQty![index].toString()}",
                                    style: joseFinSansSemiBold.copyWith(
                                        fontSize: Dimensions.fontSizeSmall,
                                        color: Theme.of(context).primaryColor)),
                                /*InkWell(
  ...
  double getAllAdonPrice(CartModel cartModel) {
    ...
    if (cartModel.addOn != null) {
      for (int i = 0; i < cartModel.addOn!.length; i++) {
        price += double.parse(cartModel.addOn![i].price.toString());
      }
    }
    return price;
  }
