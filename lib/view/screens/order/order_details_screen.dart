...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
        ...
        builder: (context, order, child) {
          ...
          if (order.orderDetails != null) {
            ...
            for (OrderDetailsModel orderDetails in order.orderDetails!) {
              ...
              addonPrice += getAllAdonPrice(orderDetails, order);
            }
          ...
          double subTotal = itemsPrice + addonPrice + (isVatInclude! ? 0 : tax);
                                                                  ...
                                                                  (order.trackModel!.paymentMethod != null &&
                                                                      ...
                                                                      ? Text(
                                                                          'cash_on_delivery'
                                                                              .tr,
                                                                          style:
                                                                              joseFinSansRegular.copyWith(color: Theme.of(context).primaryColor),
                                                                        )
                                                                      : Text(
                                                                            ...
                                                                            children: [
                                                                              Expanded(
                                                                                child: Text(
                                                                                  ...
                                                                                  style: joseFinSansRegular.copyWith(fontSize: Dimensions.fontSizeSmall),
                                                                                  maxLines: 2,
                                                                                  overflow: TextOverflow.ellipsis,
                                                                                ),
                                                                              ),
                                                                              Text('${'quantity'.tr}:', style: joseFinSansRegular),
                                                                              const SizedBox(
                                                                                width: 5.0,
                                                                              ),
                                                                              Text(order.orderDetails![index].quantity.toString(), style: joseFinSansRegular.copyWith(color: Theme.of(context).primaryColor)),
                                                                            ],
                                                                          ),
                                                                          const SizedBox(
                                                                          ...
                                                                          ClipRRect(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              image: '${Provider.of<SplashProvider>(context, listen: false).baseUrls!.productImageUrl}/'
                                                                                  '${order.orderDetails![index].productDetails!.addOns![subIndex].image!.isNotEmpty ? order.orderDetails![index].productDetails!.addOns![subIndex].image! : ''}',
                                                                              height: 70,
                                                                              width: 80,
                                                                              fit: BoxFit.cover,
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              Row(
                                                                                children: [
                                                                                  Expanded(
                                                                                    child: Text(
                                                                                      order.orderDetails![index].productDetails!.addOns![subIndex].name!,
                                                                                      style: joseFinSansRegular.copyWith(fontSize: Dimensions.fontSizeSmall),
                                                                                      maxLines: 2,
                                                                                      overflow: TextOverflow.ellipsis,
                                                                                    ),
                                                                                  ...
                                                                                  Text("1", style: joseFinSansRegular.copyWith(color: Theme.of(context).primaryColor)),
                                                                                ],
                                                                              ),
                                                                              ...
                                                                              Row(children: [
                                                                                ...
                                                                                order.orderDetails![index].discountOnProduct! > 0
                                                                                    ? Expanded(
                                                                                        child: CustomDirectionality(
                                                                                            child: Text(
                                                                                        PriceConverter.convertPrice(context, order.orderDetails![index].productDetails!.addOns![subIndex].price!.toDouble()),
                                                                                        style: joseFinSansRegular.copyWith(
                                                                                          decoration: TextDecoration.lineThrough,
                                                                                          fontSize: Dimensions.fontSizeSmall,
                                                                                          color: Theme.of(context).hintColor.withOpacity(0.6),
                                                    ...
                                                    children: [
                                                                      ...
                                                                      children: [
                                                                        CustomDirectionality(
                                                                          ...
                                                                          PriceConverter.convertPrice(
                                                                              context,
                                                                              order.orderDetails![index].price! - order.orderDetails![index].discountOnProduct!.toDouble()),
                                                                          style:
                                                                              joseFinSansRegular,
                                                                        )),
                                                                        const SizedBox(
                                                        ...
                                                        ListView.builder(
                                                          ...
                                                          itemBuilder: (context,
                                                              subIndex) {
                                                            print(
                                                                "addOn Length :=>${getData(order.orderDetails![index].productDetails!.addOns!, int.parse(order.addonQTY![subIndex].toString()))}");
                                                                  ...
                                                                  children: [
                                                                    ClipRRect(
                                                                      ...
                                                                      child: FadeInImage
                                                                        ...
                                                                        image:
                                                                            'https://celebrates.in/admin/storage/app/public/addon/'
                                                                            '${getData(order.orderDetails![index].productDetails!.addOns!, int.parse(order.addonQTY![subIndex].toString())).image!.isNotEmpty ? getData(order.orderDetails![index].productDetails!.addOns!, int.parse(order.addonQTY![subIndex].toString())).image! : ''}',
                                                                        height:
                                                                            70,
                                                                        width:
                                                                            80,
                                                                          ...
                                                                          children: [
                                                                            Row(
                                                                              children: [
                                                                                Expanded(
                                                                                  child: Text(
                                                                                    getData(order.orderDetails![index].productDetails!.addOns!, int.parse(order.addonQTY![subIndex].toString())).name!,
                                                                                    style: joseFinSansRegular.copyWith(fontSize: Dimensions.fontSizeSmall),
                                                                                    maxLines: 2,
                                                                                    overflow: TextOverflow.ellipsis,
                                                                                  ),
                                                                                ...
                                                                                Text(order.addonQTY2![subIndex].toString(), style: joseFinSansRegular.copyWith(color: Theme.of(context).primaryColor)),
                                                                              ],
                                                                            ),
                                                                            const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                                                                            Row(children: [
                                                                              CustomDirectionality(
                                                                                  child: Text(
                                                                                PriceConverter.convertPrice(context, getData(order.orderDetails![index].productDetails!.addOns!, int.parse(order.addonQTY![subIndex].toString())).price!.toDouble()),
                                                                                style: joseFinSansRegular,
                                                                              )),
                                                                              const SizedBox(width: 5),
                                                                              order.orderDetails![index].discountOnProduct! > 0
  ...
  double getAllAdonPrice(OrderDetailsModel orderDetails, OrderProvider order) {
    double price = 0;

    if (orderDetails.productDetails!.addOns != null && order.addonQTY != null) {
      print(orderDetails.addOnQtys!);
      for (int i = 0; i < order.addonQTY!.length; i++) {
        print(order.addonQTY![i].toString());

        price += double.parse(getData(orderDetails.productDetails!.addOns!,
                    int.parse(order.addonQTY![i].toString()))
                .price
                .toString()) *
            double.parse(order.addonQTY2![i]);
      }
    }
    return price;
  }

  AddOns getData(List<AddOns> data, int id) {
    print("addontID=>$id");
    AddOns item = AddOns();
...
class ItemView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
      Text(title,
          style: style ??
              joseFinSansRegular.copyWith(fontSize: Dimensions.fontSizeLarge)),
      CustomDirectionality(
          child: Text(
        subTitle,
        style: style ??
