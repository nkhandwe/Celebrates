        ...
        ? Consumer<FlashDealProvider>(
            builder: (context, flashDealProvider, child) {
              ...
              return flashDealProvider.flashDealList != null &&
                      flashDealProvider.flashDealList!.isNotEmpty
                  ? ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return SizedBox(
                          width: width,
                          child: flashDealProvider.flashDealList != null
                              ? flashDealProvider.flashDealList!.isNotEmpty
                                  ? Stack(
                                      fit: StackFit.expand,
                                      children: [
                              ...
                              : Shimmer(
                                  ...
                                  enabled:
                                      flashDealProvider.flashDealList == null,
                                  child: Container(
                  ...
                  ? GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return ProductWidget(
                          product: flashDealProvider.flashDealList![index],
                        );
                      },
                    )
                  : GridView.builder(
