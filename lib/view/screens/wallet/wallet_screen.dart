...
class _WalletScreenState extends State<WalletScreen> {
  ...
  void initState() {
    ...
    if (_isLoggedIn) {
      ...
      walletProvide.getLoyaltyTransactionList('1', false, widget.fromWallet,
                                                                ...
                                                                walletProvider
                                                                    ...
                                                                    ? walletProvider
                                                                        ...
                                                                        ? GridView
                                                                            ...
                                                                            itemBuilder:
                                                                                (context, index) {
                                                                              return widget.fromWallet
                                                                                  ? WalletHistory(
                                                                                      transaction: walletProvider.transactionList![index],
                                                                                    )
                                                                                  : HistoryItem(
                                                                                      index: index,
