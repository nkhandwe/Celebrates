...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  void initState() {
    ...
    print(widget.imageFile.length);

    if (widget.imageFile.isNotEmpty) {
      selectImage.addAll(widget.imageFile);
    }
  }
                                                                                    ...
                                                                                    ? Positioned(
                                                                                        ...
                                                                                        child: Container(
                                                                                          ...
                                                                                          child: Text(
                                                                                            ...
                                                                                            maxLines: 2,
                                                                                            overflow: TextOverflow.ellipsis,
                                                                                            style: joseFinSansRegular.copyWith(color: Colors.white, fontSize: 10),
                                                                                          ),
                                                                                        ),
                                                                                      )
                                                                                    : const SizedBox(),
  ...
  List<String> toBase64(List<XFile> fileList) {
    List<String> s = [];
    if (fileList.length > 0)
      fileList.forEach((element) {
        s.add(element.path.toString());
      });
    return s;
  }
