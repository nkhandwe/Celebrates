                  ...
                  child: Column(children: [
                        ...
                        return flashDealProvider.flashDealList != null &&
                            ...
                            : Column(children: [
                                ...
                                !ResponsiveHelper.isDesktop(context)
                                    ...
                                    : HomeItemView(
                                        productList:
                                            flashDealProvider.flashDealList)
                              ]);
                      }),
                    ...
                    Consumer<ProductProvider>(
                      ...
                      return productProvider.dailyItemList == null
                          ...
                          : productProvider.dailyItemList!.isEmpty
                              ? const SizedBox()
                              : HomeItemView(
                                  productList: productProvider.dailyItemList);
                    }),
                    if (splashProvider.configModel!.featuredProductStatus!)
                      Consumer<BannerProvider>(
                        ...
                        return banner.bannerList == null
                            ? const BannersView(isFeatured: true)
                            : banner.bannerList!.isEmpty
                                ? const SizedBox()
                                : const BannersView(
                                    isFeatured: true,
                    ...
                    Column(children: [
                      TitleWidget(
                          title:
                              getTranslated(ProductType.featuredItem, context),
                          onTap: () {
                            Navigator.pushNamed(
                                context,
                                RouteHelper.getHomeItemRoute(
                      ...
                      Consumer<ProductProvider>(
                        ...
                        return productProvider.featuredProductList == null
                            ...
                            : productProvider.featuredProductList!.isEmpty
                                ? const SizedBox()
                                : HomeItemView(
                                    productList:
                                        productProvider.featuredProductList);
                      ...
                      Column(children: [
                        ...
                        Consumer<ProductProvider>(
                          ...
                          return productProvider.mostViewedProductList == null
                              ...
                              : productProvider.mostViewedProductList!.isEmpty
                                  ? const SizedBox()
                                  : HomeItemView(
                    ...
                    if (splashProvider.configModel!.trendingProductStatus!)
                      Column(children: [
                        TitleWidget(
                            title: getTranslated(
                                ProductType.trendingProduct, context),
                            onTap: () {
                              Navigator.pushNamed(
                                  context,
                                  RouteHelper.getHomeItemRoute(
                        ...
                        Consumer<ProductProvider>(
                          ...
                          return productProvider.trendingProduct == null
                              ...
                              : productProvider.trendingProduct!.isEmpty
                                  ? const SizedBox()
                                  : HomeItemView(
                                      productList:
                                          productProvider.trendingProduct);
                        }),
                      ]),

                    if (splashProvider.configModel!.recommendedProductStatus!)
                      Column(children: [
                        TitleWidget(
                            title: getTranslated(
                                ProductType.recommendProduct, context),
                            onTap: () {
                              Navigator.pushNamed(
                                  context,
                                  RouteHelper.getHomeItemRoute(
                        ...
                        Consumer<ProductProvider>(
                          ...
                          return productProvider.recommendProduct == null
                              ...
                              : productProvider.recommendProduct!.isEmpty
                                  ? const SizedBox()
                                  : HomeItemView(
                                      productList:
                                          productProvider.recommendProduct);
                        }),
                      ]),

                    TitleWidget(
                        title:
                            getTranslated(ProductType.popularProduct, context),
                        onTap: () {
                          Navigator.pushNamed(
                              context,
                              RouteHelper.getHomeItemRoute(
                    ...
                    Consumer<ProductProvider>(
                        builder: (context, productProvider, child) {
                      return productProvider.latestProductList == null
                          ? HomeItemView(
                              productList: productProvider.latestProductList)
                          : productProvider.latestProductList!.isEmpty
                              ? const SizedBox()
                              : HomeItemView(
                                  productList:
                                      productProvider.latestProductList);
                    }),
